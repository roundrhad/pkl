...
<body class="bg-gray-50 dark:bg-gray-800">
    ...
    <div
        ...
        <span class="text-md text-gray-500 dark:text-gray-400">{{ $admin->nip }}</span>
        <span class="text-md text-gray-500 dark:text-gray-400">{{ $admin->username }}</span>
        <span class="text-md text-gray-500 dark:text-gray-400">{{ $admin->divisi }}</span>
    </div>
