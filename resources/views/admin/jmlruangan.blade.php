...
<body class="bg-gray-50 dark:bg-gray-800">
        ...
        <div
            ...
            <div class="w-full max-w-full ml-4 md:max-w-screen-md">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white max-w-full">
                    {{ $ruangan->nama }}</h5>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 max-w-full">{{ $ruangan->deskripsi }}</p>
                <a href="/lihatDetail?id={{ $ruangan->id }}"
    ...
    <div class="mx-16 my-8">
        <a href="/tambahRuangan"
            class="ml-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Tambah
            Ruangan
