    ...
    <div class="p-4">
        <div class="flex justify-center p-4 rounded-lg dark:border-gray-700 flex flex-wrap gap-4">
            ...
            <div
                ...
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Ruang
                            Serbaguna
                        </h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                        Ruang Serbaguna Balai Kota Semarang menyediakan fasilitas modern untuk berbagai kegiatan, mulai
                        dari pertemuan pemerintahan hingga acara sosial. Dengan lokasi strategis dan kapasitas yang
                        besar, ruang ini menjadi pilihan utama di tengah kota.
                    </p>
                    <a href="/lihatDetail"
