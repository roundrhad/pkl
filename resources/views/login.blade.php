...
<body>
    <div
        class="flex items-center justify-center h-screen"style="background-image: url('storage/picture/gedung.png'); background-size: cover; background-position: center;">
        <div
